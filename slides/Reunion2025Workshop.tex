...
\begin{frame}{Mokamint (Fausto Spoto, 2023--2025)}
  ...
  \begin{center}
    A new open-source (Apache 2.0) blockchain based on proof of space, similar to Signum but \alert{generic}
...
\begin{frame}{The Mokamint+Hotmoka testnet}

  Currently composed of two peers at \url{ws://panarea.hotmoka.io}:

  \begin{center}
    \begin{tikzpicture}
      \draw [fill=lightblue,thick] (0,1) rectangle +(3,1.5);
      \draw (1.5,1.75) node {{\scriptsize A73djtmYeXDLu2k\ldots}};
      \draw [fill=lightblue,thick] (0,4) rectangle +(3,1.5);
      \draw (1.5,4.75) node {{\scriptsize 7ELCyBDtwi3qmdf\ldots}};
      \draw [fill=lightred,thick] (4,4.35) rectangle +(4,0.8);
      \draw (5.5,4.75) node {{\scriptsize 9mDETtrYAzPUqR\ldots}};
      \draw (6,5.4) node {{\scriptsize local miner}};
      \draw (7.4,4.75) node {\ssd};
      \draw[-, thick] (3,4.75) -- (4,4.75);
      \draw [fill=lightred,thick] (4,2) rectangle +(4,0.8);
      \draw (6,3.1) node {{\scriptsize local miner}};
      \draw (5.5,2.4) node {{\scriptsize 5wJjYDTFRZogoH\ldots}};
      ...
      \draw (1.5,0.7) node {{peer1}};
      \draw (1.5,0.3) node {{\scriptsize (Mokamint+Hotmoka)}};
      \draw (1.5,6.2) node {{peer2}};
      \draw (1.5,5.8) node {{\scriptsize (Mokamint+Hotmoka)}};
    \end{tikzpicture}
  \end{center}
...
\end{verbatim}
  ...
  \begin{center}
    I will use my minimalistic machine (250\$):\\
...
\begin{frame}\frametitle{Conclusion}
  ...
  \item it supported the clean, generic Mokamint implementation
  \end{itemize}
...
\begin{frame}\frametitle{Future work}
  ...
  \item complete a mobile app for mining for Mokamint (Android/iOS)
  ...
  \item documentation
  \item official testnet: September 2025
