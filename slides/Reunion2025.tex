...
\begin{frame}{Blockchain mining as a competitive puzzle}
  ...
  \item<8->[{\color{red}competition:}] in case of more answers, select the one with the largest hash
  \end{description}
...
\begin{frame}\frametitle{Signum's proof of space}
  ...
  \item<5->[{\color{red}competition:}] in case of more answers, select the one with the smallest
    $\delay(\nonce,\challenge)$
  \end{description}
