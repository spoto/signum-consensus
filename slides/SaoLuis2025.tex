...
\begin{frame}{An email from \texttt{crypto42@pm.me} (September 30, 2021)}
  ...
  \begin{greenbox}{}
    ...
    I have been experimenting with a blockchain called Signum: \url{https://signum.network/}.
    They mine with
    disk drive files (plot files), which is far more at reach
    and ecological than GPUs or CPUs.

    \vspace{1ex}

    I've been trying with other developers to make their mining 100\%
    Java based. This would open the door for end-users to easily mine directly
    from their cellphones or from low-powered devices fueled by green energy.
    Unfortunately that was beyond our skills.

    \vspace{1ex}

    I saw your Hotmoka smart contract project on GitHub.
...
\begin{frame}{A work of formalization}
  ...
  \begin{greenbox}{}
    Fausto Spoto, ``A Formalization of Signum Consensus'',
...
\begin{frame}{Create your own plot file (a set of nonces)}
\end{frame}
...
\begin{frame}{Become a miner of Hotmoka/Mokamint's testnet}
\end{frame}
