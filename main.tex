...
%    \email{fausto.spoto@univr.it}}
  ...
  \begin{abstract}
    ...
    disk space for mining, instead of CPU power. Among the few theoretical or
    implemented existing proof of space solutions, Signum is
    an actual blockchain network that runs since ten years, supports smart contracts,
