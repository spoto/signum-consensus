...
been mined like that. This is because plots use an expensive hashing algorithm (shabal256) and are very big.
...
\item a proof that block grinding attacks are impossible, against previous hints~\cite{ParkKFGAP18};
